...
![控制台](docs/images/console-ui.png)
...
每次 push 到 main 分支，GitHub Actions 会自动构建 Windows 桌面版与 CLI，并以**自增版本号**发布 Release（v0.0.1 起，每次 push patch +1，见 [.github/workflows/release.yml](.github/workflows/release.yml)）；也可在 Actions 页面手动触发（workflow_dispatch）。
